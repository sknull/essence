...
Finally, as of May 2026 this is now reworked to ksoup instead of jsoup to be usable in modern
Kotlin Multiplatform projects. Next up is to migrate to a real kmp library.

Essence is now Kotlin Multiplatform
